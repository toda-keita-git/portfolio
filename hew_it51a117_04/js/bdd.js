class Congratulation {
    constructor($elm) {
      ...
      this.OPTION = {
        BREAK_POINT: 768,
        ADD_HEIGHT: 500, // 紙吹雪が降る範囲はエリア高＋この高さ
        SPEED_LEVEL: 75, // 小さくするほど速くなる
        PC_QUANTITY: 180, // BREAK_POINT以上での紙吹雪の総枚数
...
$(function(){
  $('[id^=osirase]').mouseover(function () {
    $(this).css('color',"rgba(0, 0, 0, 0.486)");
    });
  $('[id^=osirase]').mouseout(function () {
