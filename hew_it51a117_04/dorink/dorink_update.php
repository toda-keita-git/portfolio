...
<table class="table01">
  <tbody>
    ...
    <tr><th>詳細</th><td><textarea type="text"name="setumei" rows=”3″ cols=”50″ wrap=”hard”><?php echo $fail2[3]; ?></textarea></td></tr>
  </tbody>
</table>
    <div class="button_tab">
    <button type="submit"><a href="dorink.php"><span>戻る</span></a><div class="liquid1"></div></button>
